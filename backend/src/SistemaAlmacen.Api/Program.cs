...
try
{
    ...
    try
    {
        ...
        db.Database.ExecuteSqlRaw(@"
            ...
            ALTER TABLE ""Movimientos"" ADD COLUMN IF NOT EXISTS ""NumeroLote"" TEXT NULL;
            ALTER TABLE ""Movimientos"" ADD COLUMN IF NOT EXISTS ""FechaVencimiento"" TIMESTAMP WITH TIME ZONE NULL;
            ALTER TABLE ""Movimientos"" ADD COLUMN IF NOT EXISTS ""PrecioUnitario"" NUMERIC(18,2) NULL;
            ALTER TABLE ""Productos"" ADD COLUMN IF NOT EXISTS ""PrecioUnitario"" NUMERIC(18,2) NULL;

            CREATE TABLE IF NOT EXISTS ""Lotes"" (
                ""Id"" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                ""ProductoId"" INT NOT NULL REFERENCES ""Productos""(""Id"") ON DELETE CASCADE,
                ""AlmacenId"" INT NOT NULL REFERENCES ""Almacenes""(""Id"") ON DELETE CASCADE,
                ""CodigoLote"" TEXT NOT NULL,
                ""FechaVencimiento"" TIMESTAMP WITH TIME ZONE NULL,
                ""Cantidad"" NUMERIC(18,3) NOT NULL DEFAULT 0,
                ""FechaIngreso"" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP
            );

            CREATE TABLE IF NOT EXISTS ""RecepcionesMateriaPrima"" (
                ""Id"" INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                ""FechaRecepcion"" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT CURRENT_TIMESTAMP,
                ""ProductoId"" INT NOT NULL REFERENCES ""Productos""(""Id"") ON DELETE RESTRICT,
                ""AlmacenId"" INT NOT NULL REFERENCES ""Almacenes""(""Id"") ON DELETE RESTRICT,
                ...
                ""DictamenCalidad"" INT NOT NULL DEFAULT 1,
